...
#import "IXISpeechRequestProtocol-Protocol.h"

@class NSDictionary, NSHTTPURLResponse, NSString;

@interface XIGatewaySpeechRequest : XIGatewayRequest <IXISpeechRequestProtocol>
{
}

@property(readonly, copy) NSString *description;
- (void)beginRequestWithAudioData:(id)arg1 sourceLanguage:(id)arg2 targetLanguage:(id)arg3;
