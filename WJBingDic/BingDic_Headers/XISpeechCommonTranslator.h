...
@interface XISpeechCommonTranslator : NSObject <IXITranslateListener, IXICommonTranslatorProtocol>
{
    id <IXIRestSpeechTranslatorProtocol> _speechTranslator;
...
@property(retain, nonatomic) id <IXIRestSpeechTranslatorProtocol> speechTranslator; // @synthesize speechTranslator=_speechTranslator;
- (void).cxx_destruct;
