...
@interface _TtC7BingDic21ReadScenesListRequest : _TtC7BingDic15HttpRequestBase
{
    // Error parsing type: , name: listUrl
...
- (void)beginScenesListRequestWithType:(id)arg1;
@property(nonatomic, copy) NSArray *readScenesList; // @synthesize readScenesList;
@property(nonatomic, readonly) NSString *listUrl; // @synthesize listUrl;
